...
public:
    ...
    virtual double operator()(std::size_t i, std::size_t j, double& lhs, double& rhs) final
    {
        return lhs + rhs;
    }
    
    PUPable_decl(add_op);
    add_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    subtract_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    multiply_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    divide_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    power_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    modulo_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(max_op);
    max_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(min_op);
    min_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    greater_than_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
public:
    ...
    less_than_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
{
public:
    equal_op() : epsilon_(1e-10) {}
    equal_op(double epsilon) : epsilon_(epsilon) {}
    ~equal_op() = default;
    ...
    equal_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
...
public:
    ...
    atan2_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
    void pup(PUP::er& p) final { ct::binary_operator::pup(p); }
};
...
{
public:
    weighted_average_op() : w1_(0.5), w2_(0.5) {} // Equal weights by default
    weighted_average_op(double w1, double w2) : w1_(w1), w2_(w2) {}
    ...
    weighted_average_op(CkMigrateMessage* m) : ct::binary_operator(m) {}
...
namespace binary_ops {
    ...
    inline std::shared_ptr<ct::binary_operator> equal(double epsilon = 1e-10) {
    ...
    inline std::shared_ptr<ct::binary_operator> weighted_average(double w1, double w2) {
