...
namespace ct {
    namespace mat_impl {
        ...
        public:
            ...
            std::size_t dispatch_size() const
            {
                ...
                //     }
                // }
                dispatch_count = shape_matrix_queue_.size();

                return dispatch_count;
            }

            void codegen(instr_t& instructions) {
                traceBeginUserBracketEvent(2);
    ...
    public:
        ...
        matrix& operator+=(ct::mat_impl::mat_expression<LHS, RHS> const& e)
        {
            ...
            ct::mat_impl::mat_node new_root{
                ct::util::Operation::inplace_add, row_size_, col_size_};
            new_root.left_ = -1;
            new_root.right_ = 1;
        ...
        matrix& operator-=(ct::mat_impl::mat_expression<LHS, RHS> const& e)
        {
            ...
            ct::mat_impl::mat_node new_root{
                ct::util::Operation::inplace_sub, row_size_, col_size_};
            new_root.left_ = -1;
            new_root.right_ = 1;
            new_root.mat_row_len_ = row_size_;
            new_root.mat_col_len_ = col_size_;
        ...
        matrix& operator/=(ct::mat_impl::mat_expression<LHS, RHS> const& e)
        {
            ...
            ct::mat_impl::mat_node new_root{
                ct::util::Operation::inplace_divide, row_size_, col_size_};
            new_root.left_ = -1;
            new_root.right_ = 1;
            new_root.mat_row_len_ = row_size_;
            new_root.mat_col_len_ = col_size_;
