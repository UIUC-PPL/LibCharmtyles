...
public:
    ...
    virtual double operator()(std::size_t i, std::size_t j, double& value) final
    {
        return -value;
    }
    
    PUPable_decl(negate_op);
    negate_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(abs_op);
    abs_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    square_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    sqrt_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    reciprocal_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(sin_op);
    sin_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(cos_op);
    cos_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(log_op);
    log_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    PUPable_decl(exp_op);
    exp_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
...
public:
    ...
    scale_op(double scale_factor) : scale_factor_(scale_factor) {}
    ~scale_op() = default;
    ...
    scale_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
...
public:
    ...
    add_constant_op(double constant) : constant_(constant) {}
    ...
    add_constant_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
...
public:
    ...
    relu_op(CkMigrateMessage* m) : ct::unary_operator(m) {}
    void pup(PUP::er& p) final { ct::unary_operator::pup(p); }
};
